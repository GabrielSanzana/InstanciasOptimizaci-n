...
Original file is located at
    https://colab.research.google.com/drive/1836-mrC_8Lw1ze2sLOidlnSiwhlxV8v3
...
if __name__ == '__main__':
    ...
    K = 200  # Number of generations (mini-SAs)
...
"""# Código para generación de gráficos Histograma y Box plot"""
...
if __name__ == '__main__':
    ...
    FILE_PATH = 'codigo_analisis_excel\\a280_n279_uncorr_02.ttp' # 'rl1323_n13220_bounded-strongly-corr_05.ttp'
    print(f"[{datetime.datetime.now().strftime('%H:%M:%S')}] Cargando problema TTP desde: {FILE_PATH}")
    items_data_raw, city_coords_raw, KNAP_CAP_total, MIN_SPEED, MAX_SPEED, RENT = parsear_ttp(FILE_PATH)
    ...
    NUM_GENERACIONES = 2   # Unificación: número de generaciones para cada simulación
...
"""# Código para generación de gráficos del recorrido de la solución"""
...
if __name__ == '__main__':
    ...
    FILE_PATH = 'ruta.ttp' # Se reemplaza ruta por la ruta de la instancia a graficar
    print(f"[{datetime.datetime.now().strftime('%H:%M:%S')}] Cargando problema TTP desde: {FILE_PATH}")
    items_data_raw, city_coords_raw, KNAP_CAP_total, MIN_SPEED, MAX_SPEED, RENT = parsear_ttp(FILE_PATH)
